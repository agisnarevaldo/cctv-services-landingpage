        ...
        <main className="flex flex-col gap-16">
            ...
            <section className="py-8 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-2xl font-medium mb-2">Lihat Bagaimana Kami Bekerja</h2>
                    <p className="text-gray-600 mb-6">Video profil dan proses instalasi CCTV profesional dari tim kami</p>
                    <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-xl">
                        <iframe
                            src="https://www.youtube.com/embed/0I33icm2omY?si=RjxxI1XQGJcL0qCs"
                            title="Video Marketing Mitra Asia CCTV"
